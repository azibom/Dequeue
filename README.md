...
## what is Dequeue ?
if you have queue and you can push or pop form first or end of it you can call it dequeue :)

if you want to implement it with two stack you only need to connet the two stacks form the end and handle some exceptions ...
lets look at code right now
